...
const EXCLUDE_IDS = new Set([
  ...
  // Non-full blocks (not 1x1x1 solid cubes)
  ...
  'minecraft:farmland', 'minecraft:farmland_moist',
  'minecraft:glow_item_frame', 'minecraft:item_frame', 'minecraft:itemframe_background',
  'minecraft:jack_o_lantern',
  'minecraft:jigsaw', 'minecraft:jigsaw_lock',
  'minecraft:lava',
  'minecraft:powder_snow',
  'minecraft:piston', 'minecraft:piston_top_normal', 'minecraft:piston_top_sticky',
  'minecraft:sculk_catalyst_side_bloom', 'minecraft:sculk_catalyst_top_bloom',
  'minecraft:sculk_shrieker_can_summon_inner',
  'minecraft:smooth_stone_slab', 'minecraft:stone_slab',
  'minecraft:structure_block', 'minecraft:structure_block_corner', 'minecraft:structure_block_data', 'minecraft:structure_block_load', 'minecraft:structure_block_save',
  'minecraft:trial_spawner_top_active', 'minecraft:trial_spawner_top_active_ominous',
  'minecraft:trial_spawner_top_ejecting_reward', 'minecraft:trial_spawner_top_ejecting_reward_ominous',
  'minecraft:trial_spawner_top_inactive', 'minecraft:trial_spawner_top_inactive_ominous',
  'minecraft:vault_bottom_ominous', 'minecraft:vault_top_ejecting', 'minecraft:vault_top_ejecting_ominous', 'minecraft:vault_top_ominous',
  // Old naming duplicates (1.12.2 renamed in 1.13+)
  'minecraft:door_birch_lower', 'minecraft:door_birch_upper', 'minecraft:door_dark_oak_lower', 'minecraft:door_dark_oak_upper', 'minecraft:door_spruce_lower', 'minecraft:door_spruce_upper',
  'minecraft:noteblock',
  'minecraft:stone_andesite', 'minecraft:stone_andesite_smooth', 'minecraft:stone_diorite', 'minecraft:stone_diorite_smooth', 'minecraft:stone_granite', 'minecraft:stone_granite_smooth',
  'minecraft:sandstone_carved', 'minecraft:sandstone_normal', 'minecraft:sandstone_smooth',
  'minecraft:red_sandstone_carved', 'minecraft:red_sandstone_normal', 'minecraft:red_sandstone_smooth',
  'minecraft:prismarine_dark', 'minecraft:prismarine_rough',
  'minecraft:red_nether_brick',
  'minecraft:sponge_wet',
  'minecraft:quartz_block_lines',
  'minecraft:grass_side_snowed',
  'minecraft:dirt_podzol',
  'minecraft:respawn_anchor_side0', 'minecraft:respawn_anchor_side1', 'minecraft:respawn_anchor_side2', 'minecraft:respawn_anchor_side3', 'minecraft:respawn_anchor_side4',
])
