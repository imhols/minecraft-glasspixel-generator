...
export default function ImageUploader({ onImageLoaded, hasImage, originalW, originalH }: {
  ...
  if (hasImage) {
    return (
      <div className="upload-bar">
        <div className="upload-bar-info">
          <span className="upload-bar-name">{fileName || t('upload.loaded')}</span>
        </div>
        {originalW ? <span className="upload-bar-size">{originalW}×{originalH}</span> : null}
